...
$StatusAccept = "UPDATE ApplyJob SET `STATUS` = 'Accepted' WHERE ApplyID = $applyID";
...
$notificationMessage = mysqli_real_escape_string($conn, "Your application for the job '$jobTitle' has been accepted");

$sendNotification = "INSERT INTO `Notification` (SenderUserID, ReceiverUserID, NotificationMessage, NotificationType) 
                     VALUES ('$userID', '$userApplied', '$notificationMessage', 'Accepted')";
